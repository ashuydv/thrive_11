    ...
    <div>
      <section class="text-gray-400 bg-black body-font">
        ...
        <div className="relative">
          ...
          >
            <div class=" w-[1240px] mx-auto">
              <div class="flex flex-wrap m-4 mb-24 px-32 py-40 bg-gray-500 bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-5 text-center z-20 rounded-3xl">
                <div class="p-4 sm:w-1/3 w-1/2">
                  ...
                  <p class="leading-relaxed text-gray-100 text-lg">Alpha Users</p>
                </div>
                <div class="p-4 sm:w-1/3 w-1/2">
                  <h2 class="title-font font-medium sm:text-4xl text-3xl text-white stats ">
                    <CountUp start={0} end={100} suffix="+" />
                  </h2>
                  <p class="leading-relaxed text-gray-100 text-lg">Collaborations</p>
                </div>
                <div class="p-4 sm:w-1/3 w-1/2">
                  <h2 class="title-font font-medium sm:text-4xl text-3xl text-white stats ">
